...
#define N_MOT_MAX       700            // [rpm] Maximum motor speed limit
...
*/
    ...
    #define AUX_INPUT1            3, -1000, 0, 1000, 10  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
    #define AUX_INPUT2            3, -1000, 0, 1000, 10  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #else
