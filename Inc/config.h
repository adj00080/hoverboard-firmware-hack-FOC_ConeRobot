...
#define BAT_CALIB_REAL_VOLTAGE  3800      // input voltage measured by multimeter (multiplied by 100). In this case 43.00 V * 100 = 4300
...
#define FIELD_WEAK_MAX  1               // [A] Maximum Field Weakening D axis current (only for FOC). Higher current results in higher maximum speed. Up to 10A has been tested using 10" wheels.
...
#define ADC_PROTECT_THRESH        3000     // ADC Protection threshold below/above the MIN/MAX ADC values
...
*/
  ...
  #define PRI_INPUT1            0, 0, 0, 4095, 10      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define PRI_INPUT2            1, 0, 0, 4095, 0      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
    ...
    #define AUX_INPUT1          0, 1700, 2000, 2300, 0  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
    #define AUX_INPUT2          0, 0, 2050, 4095, 0  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #else
...
//TODO ADD VALIDATION
  ...
  #define STEER_COEFFICIENT   16384      // 0.5f - higher value == stronger. if you do not want any steering, set it to 0.0; 0.0 to 1.0
